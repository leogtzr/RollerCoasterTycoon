...
public class GuestImage
{
    ...
    public static BufferedImage[] getSouthImage(int variation)
    {
        switch (variation)
        {
            case (1):
    ...
    public static BufferedImage[] getEastImage(int variation)
    {
        switch (variation)
        {
            case (1):
    ...
    public static BufferedImage[] getWestImage(int variation)
    {
        switch (variation)
        {
            case (1):
